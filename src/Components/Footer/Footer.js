...
export default function Footer() {
  ...
  let renderPartners = () =>
    infoRap.map((logo) => (
      <ul>
        <li>
          <img alt="" src={logo.logo} className="w-10 lg:w-10" />
        </li>
      </ul>
    ));
        ...
        <div className="footerCertificate">
          <div className="flex justify-between space-x-8">
            ...
            <div>
              ...
              <p>
                Business Registration Certificate: 0349896940, first registered
                on December 24, 2023 issued by the Department of Planning and
                Investment of Ho Chi Minh City
              </p>
              <p>Hotline: 1900 6017</p>
              <p>
                COPYRIGHT 2023 CYBER MOVIE VIETNAM CO., LTD. ALL RIGHTS RESERVED
              </p>
            </div>
          </div>
        </div>
